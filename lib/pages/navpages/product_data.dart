...
class ProductDetails extends StatefulWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Product #$index Details"),
      ),
      body: Center(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(r"1.5 SR", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 20)),
          Text("Last Update:", style: TextStyle(fontWeight: FontWeight.w100, fontSize: 12))
          //SizedBox(height: 20),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(r"1.25 SR", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 20)),
          Text("Last Update:", style: TextStyle(fontWeight: FontWeight.w100, fontSize: 12))
          //SizedBox(height: 20),
          //property()
        ],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(r"1.55 SR", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 20)),
          Text("Last Update:", style: TextStyle(fontWeight: FontWeight.w100, fontSize: 12))
          //SizedBox(height: 20),
          //property()
        ],
  ...
  Widget AddStoreButton() {
    return Container(
        child: FlatButton(
            ...
            child: Text("Add Price", style: TextStyle(color: Colors.white),))
    );
  }
